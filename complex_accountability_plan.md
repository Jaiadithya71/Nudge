...
```mermaid
graph TD
    A[Month 1: Onboard Thirdwave] --> B[Month 12: Evaluate Technical Scope & JLPT N3]
    B -->|Passed N3 & Strong Ownership| C[Phase 2: Target Go/GCP & JLPT N2]
    B -->|Failed N3| D[Gate 1 Pivot: English-First Focus]
    B -->|Delayed Ownership| E[Gate 2 Pivot: Offshore Search]
    C --> F[Month 24: Transition Applications]
    D --> F
    E --> F
    F -->|Offers Secured| G[Phase 3: Relocate to Tokyo ¥7M+]
    F -->|No Offers| H[Gate 3 Pivot: SG/EU/Remote & Referrals]
```
